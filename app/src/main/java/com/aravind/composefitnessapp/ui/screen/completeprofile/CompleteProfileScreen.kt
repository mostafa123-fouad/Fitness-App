...
import com.aravind.composefitnessapp.calculateAge
import com.aravind.composefitnessapp.ui.screen.registeruser.updateProfile
    ...
    Column(
        ...
        Button(
            modifier = Modifier
                ...
                .height(55.dp),
            onClick = {
                updateProfile(gender = selectedItem,dateOfBirth =dateOfBirth, weight = weight, height = height,age= age)
                onCompleteProfile()
                 },
