        ...
        Column(
            ...
            Button(
                ...
                onClick = {
                    ...
                    if (passwordError) {
                        Toast.makeText(context, "Password must be at least 8 characters, contain letters, numbers, and special characters", Toast.LENGTH_SHORT).show()
                    } else {
                        if (!phoneError && checkedState.value && fullName.isNotBlank() && email.isNotBlank() && password.isNotBlank()) {
                            registerUser(
                                fullName = fullName,
                                phone = phoneNumber,
                                email = email,
                            ...
                            if (!checkedState.value || fullName.isBlank() || email.isBlank() || password.isBlank()) {
